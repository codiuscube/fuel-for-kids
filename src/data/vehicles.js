...
export const WHY = {
  ...
  safe:
    'IIHS award for a representative model year of this generation, the IIHS updated moderate-overlap front test with a dummy in the rear seat (the one that matters when the passengers are your kids), the NHTSA overall star rating, and whether automatic emergency braking is standard. Scored 0 to 1 for Best overall. Awards earned before the 2024 criteria are discounted, because until then a Top Safety Pick did not have to pass the rear-seat test; a car never run through that test gets a middling 0.4 there, not credit from the older badge. A car nobody has looked up scores 0.4 overall rather than zero. Ratings are for the model year shown on the IIHS page and may differ by trim and headlight package.',
  rel:
